...
final _tokenProgramId = base58.decode(
  'TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA',
);
final _ataProgramId = base58.decode(
...
String deriveATA({required String walletPubkey, required String mintPubkey}) {
...
void main() {
  // dummy valid-looking wallet address
