      ...
      div(
        ...
        [
          ...
          div(classes: 'p-6 flex-1 space-y-6', [
            ...
            div(classes: 'flex flex-col items-center gap-4', [
              ...
              div(classes: 'flex items-center gap-4', [
                button(
                  classes:
                      'p-3 rounded-xl border ${isDark ? "border-zinc-700 bg-zinc-800" : "border-zinc-200 bg-zinc-100"} hover:opacity-80 transition-opacity',
          ...
          div(classes: 'p-6 border-t ${isDark ? "border-zinc-800" : "border-zinc-100"}', [
            button(
              classes:
                  'w-full py-3 rounded-xl font-bold text-white logo-gradient hover:opacity-90 transition-opacity flex items-center justify-center gap-2',
