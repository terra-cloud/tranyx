...
class _ManageVehicleModalState extends State<ManageVehicleModalComponent> {
      ...
      [
        div(
          ...
          [
            // Close button
            button(
              classes: 'absolute top-4 right-4 p-2 rounded-full hover:bg-zinc-800/20 transition-colors',
  ...
  Component _verificationRow(String labelText, bool verified, bool isDark) {
    return div(classes: 'flex items-center justify-between text-xs', [
      span(classes: isDark ? 'text-zinc-300' : 'text-zinc-600', [Component.text(labelText)]),
