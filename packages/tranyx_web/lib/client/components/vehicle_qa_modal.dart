        ...
        div(classes: 'flex-1 overflow-y-auto p-6 space-y-6', [
          if (_isLoading)
            ...
            div(classes: 'text-center p-10', [
              ...
              p(classes: 'text-sm $subTextCls mt-1', [Component.text('Be the first to ask the host a question about this vehicle.')]),
            ])
          else
                    ...
                    if (_answeringQuestionId == q['id'])
                      div(classes: 'flex flex-col gap-2', [
                        ...
                        div(classes: 'flex justify-end gap-2', [
                          button(
                            classes: 'px-4 py-1.5 rounded-lg text-xs font-bold ${isDark ? "hover:bg-zinc-800" : "hover:bg-zinc-200"}',
                            events: {'click': (_) => setState(() { _answeringQuestionId = null; _answerText = ''; })},
                            [Component.text('Cancel')]
                          ),
                          button(
                            classes: 'px-4 py-1.5 rounded-lg text-xs font-bold text-white bg-purple-500 hover:bg-purple-600',
        ...
        if (!isHost)
          div(classes: 'p-4 border-t ${isDark ? "border-zinc-800 bg-zinc-900" : "border-zinc-200 bg-zinc-50"} rounded-b-3xl', [
            div(classes: 'flex gap-2', [
              ...
              button(
                classes: 'px-6 py-3 rounded-xl text-white font-bold logo-gradient hover:opacity-90 transition-opacity',
