...
Component lIcon(String name, {String cls = 'w-5 h-5'}) {
  final path = _lucidePaths[name] ?? _lucidePaths['help-circle']!;
  return svg(
...
/// SVG path data for each Lucide icon used in the app.
const Map<String, String> _lucidePaths = {
  ...
  'bell-off': '<path d="M8.56 2.9A7 7 0 0 1 19 9v4m-2 4H2s3-2 3-9a4.67 4.67 0 0 1 .08-.86"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/><line x1="2" y1="2" x2="22" y2="22"/>',
  ...
  'message-circle-question': '<path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  ...
  'wallet': '<path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4"/><path d="M18 12a2 2 0 0 0 0 4h2v-4z"/>',
